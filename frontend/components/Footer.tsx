        ...
        <div className="flex flex-col sm:flex-row items-start justify-between gap-8">
          <div>
            ...
            <p className="text-sm text-zinc-500 dark:text-zinc-400">
              Payment Infrastructure for APIs
            </p>
          </div>

          <Link
            href="https://github.com/GTG-Labs/sangria-net"
            className="flex items-center gap-2 text-zinc-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white transition-colors text-sm"
          >
            <svg viewBox="0 0 1024 1024" fill="currentColor" className="w-5 h-5" aria-hidden="true">
