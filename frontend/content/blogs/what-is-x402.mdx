...
1. **Client external, merchant on Sangria** _(supported)_
   An external client (AI agent or raw wallet) pays USDC on-chain; Sangria credits the merchant's fiat balance.

2. **Client on Sangria, merchant external** _(coming soon)_
...
3. **Client and merchant both on Sangria** _(coming soon)_
